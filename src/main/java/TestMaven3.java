...
public class TestMaven3 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement next3 = driver.findElement(By.xpath("//li/a[@ng-click='wizard.go(5)'][text()='Next']/span"));
		next3.click();
		Thread.sleep(2000);
		...
		WebElement next4 = driver.findElement(By.xpath("//li/a[@ng-click='wizard.go(6)'][text()='Next']/span"));
		next4.click();
		Thread.sleep(2000);
		...
		WebElement next5 = driver.findElement(By.xpath("//li/a[@ng-click='wizard.go(7)'][text()='Next']/span"));
		next5.click();
		Thread.sleep(3000);
